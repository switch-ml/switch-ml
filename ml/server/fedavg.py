...
from ml.typings import Parameters
from ml.server.base_strategy import Strategy
from ml.parameter import weights_to_parameters, parameters_to_weights
...
class FedAvg(Strategy):
    ...
    def configure_fit(self, rnd: int, parameters, client_manager):
        ...
        fit_ins = EvaluateIns(parameters, config)
